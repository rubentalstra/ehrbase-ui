...
//
// Also binds the framework-agnostic @/server/auth package to TanStack Start's
// request-context API.
//
...
// start.ts cannot do this binding itself because it IS bundled into the client
// environment for the route tree's client-side startInstance reference (per
// TanStack Start's import-protection plugin).
//
