...
- [~] **1A** Repo skeleton + ADR seeding + `.claude/` setup (this commit) — governance docs (`docs/governance/`) deferred to 1O
- [ ] **1B** TanStack Start + Tailwind v4 scaffold — §4, §6
- [ ] **1C** shadcn init + first component batch — §6
