// @ehrbase-ui/audit — pure-type, browser-safe public surface.
//
...
// packages (@ehrbase-ui/auth, @ehrbase-ui/http-bff, …):
//
 ...
 * `@ehrbase-ui/audit/server`. The two MUST stay in sync; the contract
